...
command_to_execute = command_to_execute.replace('<ROUTE_ADD_CMD>', route_add_cmd)
command_to_execute2 = command_to_execute2.replace('<ROUTE_ADD_CMD>', route_add_cmd)
