...
if template_name in ('3nic', 'ha-avset', 'cluster_3nic'):
...
if stack_type == 'existing_stack':
    if template_name in ('2nic', '3nic', 'ha-avset', 'cluster_3nic'):
...
if template_name in ('1nic', '2nic', '3nic', 'ha-avset', 'cluster', 'cluster_3nic', 'ltm_autoscale', 'waf_autoscale'):
    if template_name in ('1nic', '2nic', '3nic', 'ha-avset', 'cluster_3nic'):
...
if template_name in ('cluster', 'ltm_autoscale', 'waf_autoscale', 'cluster_3nic'):
...
if template_name in ('1nic', '2nic', '3nic', 'cluster', 'ha-avset', 'cluster_3nic'):
    if stack_type == 'new_stack':
...
if template_name in ('1nic', '2nic', '3nic', 'ha-avset', 'cluster', 'cluster_3nic'):
...
lic_support = {'1nic': 'Both', '2nic': 'Both', '3nic': 'Both', 'cluster': 'Both', 'cluster_3nic': 'Both', 'ha-avset': 'Both', 'ltm_autoscale': 'PAYG', 'waf_autoscale': 'PAYG' }
lic_key_count = {'1nic': 1, '2nic': 1, '3nic': 1, 'cluster': 2, 'cluster_3nic': 2, 'ha-avset': 2, 'ltm_autoscale': 0, 'waf_autoscale': 0 }
...
if template_name in ('1nic', '2nic', '3nic', 'cluster', 'ha-avset', 'cluster_3nic', 'ltm_autoscale', 'waf_autoscale') and script_location:
...
######################################## Create/Modify README's ########################################
    ...
    ## Title Text ##
    readme_text['title_text'] = {'1nic': 'Single NIC', '2nic': '2 NIC', '3nic': '3 NIC', 'cluster': 'ConfigSync Cluster: Single NIC', 'cluster_3nic': 'ConfigSync Cluster: 3 NIC', 'ha-avset': 'HA Cluster: Active/Standby', 'ltm_autoscale': 'AutoScale BIG-IP LTM - VM Scale Set', 'waf_autoscale': 'AutoScale BIG-IP WAF(LTM+ASM) - VM Scale Set' }
    ## Intro Text ##
