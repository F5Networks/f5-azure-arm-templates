...
if template_name == 'cluster_3nic':
    ...
    if 'experimental' in created_file:
        probes_to_use = [{"name": "tcp-probe", "properties": { "protocol": "Tcp", "port": 3456, "intervalInSeconds": 5, "numberOfProbes": 2 }}]
