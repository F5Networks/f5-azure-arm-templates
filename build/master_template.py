...
post_cmd_to_execute = ", '; if [[ $? == 0 ]]; then rm -f /config/cloud/passwd; tmsh load sys application template f5.service_discovery.tmpl; bash /config/customConfig.sh; else exit 1; fi'"
if template_name in 'ha-avset':
