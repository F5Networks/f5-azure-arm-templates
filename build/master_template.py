...
if template_name in ('ltm_autoscale', 'waf_autoscale'):
    ...
    data['variables']['f5NetworksSolutionScripts'] = "[concat('https://raw.githubusercontent.com/F5Networks/f5-azure-arm-templates/', variables('f5NetworksTag'), '/experimental/autoscale/waf/deploy_scripts')]"
...
if template_name in ('waf_autoscale'):
    ...
    autoscale_file_uris += [ "[concat(variables('f5NetworksSolutionScripts'), '/deploy_waf.sh')]" ]
if template_name in ('ltm_autoscale', 'waf_autoscale'):
