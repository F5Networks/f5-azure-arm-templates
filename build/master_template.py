...
######################################## Create/Modify README's ########################################
    ...
    readme_text['stack_type_text']['existing_stack'] = 'This template deploys into an existing networking stack, the networking infrastructure must be available prior to deploying the solution.'
