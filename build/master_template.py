...
post_cmd_to_execute = ", '; rm -f /config/cloud/passwd; tmsh load sys application template f5.service_discovery.tmpl'"
if template_name in 'ha-avset':
    ...
    post_cmd_to_execute = ", '; tmsh load sys application template f5.service_discovery.tmpl'"
...
######################################## Create/Modify README's ########################################
    readme_text = {'title_text': {}, 'intro_text': {}, 'help_text': {}, 'deploy_links': {}, 'version_tag': {}, 'ps_script': {}, 'bash_script': {}, 'config_example_text': {}, 'license_map': {} }
    ## Title Text ##
