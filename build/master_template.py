...
content_version = '3.3.0.0'
f5_networks_tag = 'release-3.3.0.0'
f5_cloud_libs_tag = 'v3.3.0'
...
if template_name in ('standalone_1nic', 'standalone_2nic', 'standalone_3nic', 'standalone_multi_nic', 'ha-avset', 'cluster_1nic', 'cluster_3nic', 'ltm_autoscale', 'waf_autoscale'):
    ...
    if stack_type == 'existing_stack':
        ...
        if template_name in ('standalone_2nic', 'standalone_3nic', 'standalone_multi_nic', 'cluster_3nic', 'ha-avset'):
            ...
            data['variables']['tmmRouteGw'] = "[concat(take(parameters('externalIpAddressRangeStart'), lastIndexOf(parameters('externalIpAddressRangeStart'), '.')), '.1')]"
            data['variables']['mgmtRouteGw'] = "[concat(take(parameters('mgmtIpAddress'), lastIndexOf(parameters('mgmtIpAddress'), '.')), '.1')]"
            data['variables']['routeCmdArray'] = route_cmd_array
            ...
            if template_name in ('ha-avset', 'cluster_3nic'):
                ...
                data['variables']['mgmtRouteGw'] = "[concat(take(parameters('mgmtIpAddressRangeStart'), lastIndexOf(parameters('mgmtIpAddressRangeStart'), '.')), '.1')]"
...
command_to_execute = ''; command_to_execute2 = ''; route_add_cmd = ''
