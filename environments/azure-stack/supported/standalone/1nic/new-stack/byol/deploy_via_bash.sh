...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion licenseKey1 vnetAddressPrefix ntpServer timeZone allowUsageAnalytics resourceGroupName "
