...
required_variables="numberOfInstances adminUsername authenticationType adminPasswordOrKey dnsLabel instanceType imageName bigIpVersion vnetAddressPrefix ntpServer timeZone allowUsageAnalytics resourceGroupName licenseType "
