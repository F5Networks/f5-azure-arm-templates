...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion numberOfAdditionalNics additionalNicLocation numberOfExternalIps vnetAddressPrefix tenantId clientId servicePrincipalSecret managedRoutes ntpServer timeZone customImageUrl allowUsageAnalytics resourceGroupName licenseType "
