...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion bigIpModules licenseKey1 vnetAddressPrefix declarationUrl ntpServer timeZone customImage allowUsageAnalytics allowPhoneHome resourceGroupName "
