...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion licenseKey1 vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddress avSetChoice declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
