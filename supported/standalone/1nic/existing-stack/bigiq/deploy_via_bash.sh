...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIqAddress bigIqUsername bigIqPassword bigIqLicensePoolName bigIqLicenseSkuKeyword1 bigIqLicenseUnitOfMeasure bigIpVersion vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddress avSetChoice declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
