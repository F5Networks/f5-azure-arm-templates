...
required_variables="adminUsername authenticationType adminPasswordOrKey uniqueLabel instanceName instanceType imageName bigIpVersion vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddress avSetChoice ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
