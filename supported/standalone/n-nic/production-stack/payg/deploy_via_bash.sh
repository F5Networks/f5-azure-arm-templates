...
required_variables="adminUsername authenticationType adminPasswordOrKey instanceName instanceType imageName bigIpVersion numberOfAdditionalNics additionalNicLocation numberOfExternalIps vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddress externalSubnetName externalIpAddressRangeStart internalSubnetName internalIpAddress avSetChoice uniqueLabel declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
