...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion numberOfAdditionalNics additionalNicLocation numberOfExternalIps vnetAddressPrefix ntpServer timeZone customImageUrl allowUsageAnalytics resourceGroupName licenseType "
