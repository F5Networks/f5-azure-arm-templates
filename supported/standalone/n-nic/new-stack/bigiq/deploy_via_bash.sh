...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIqAddress bigIqUsername bigIqPassword bigIqLicensePoolName bigIqLicenseSkuKeyword1 bigIqLicenseUnitOfMeasure bigIpVersion numberOfAdditionalNics additionalNicLocation numberOfExternalIps vnetAddressPrefix declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
