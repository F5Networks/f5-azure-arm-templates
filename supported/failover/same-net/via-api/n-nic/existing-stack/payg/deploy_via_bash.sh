...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion licensedBandwidth numberOfAdditionalNics additionalNicLocation numberOfExternalIps vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart externalSubnetName externalIpSelfAddressRangeStart externalIpAddressRangeStart internalSubnetName internalIpAddressRangeStart tenantId clientId servicePrincipalSecret managedRoutes ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
