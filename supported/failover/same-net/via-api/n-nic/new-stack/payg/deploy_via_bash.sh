...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion numberOfAdditionalNics additionalNicLocation numberOfExternalIps vnetAddressPrefix declarationUrl tenantId clientId servicePrincipalSecret managedRoutes ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
