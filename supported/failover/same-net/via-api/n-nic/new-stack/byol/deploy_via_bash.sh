...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion licenseKey1 licenseKey2 numberOfAdditionalNics additionalNicLocation numberOfExternalIps vnetAddressPrefix managedRoutes tenantId clientId servicePrincipalSecret declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
