...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName numberOfExternalIps enableNetworkFailover internalLoadBalancerType internalLoadBalancerProbePort instanceType imageName bigIpVersion bigIpModules licenseKey1 licenseKey2 vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart externalSubnetName externalIpAddressRangeStart externalIpSelfAddressRangeStart internalSubnetName internalIpAddressRangeStart provisionPublicIP declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
