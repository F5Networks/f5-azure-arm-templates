...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceType imageName bigIpVersion licenseKey1 licenseKey2 vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart numberOfInstances declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
