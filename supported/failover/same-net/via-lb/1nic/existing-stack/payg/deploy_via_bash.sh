...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceType imageName bigIpVersion vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart numberOfInstances declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
