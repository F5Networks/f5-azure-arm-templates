...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceType imageName bigIqAddress bigIqUsername bigIqPassword bigIqLicensePoolName bigIqLicenseSkuKeyword1 bigIqLicenseUnitOfMeasure bigIpVersion bigIpModules vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart provisionPublicIP declarationUrl ntpServer timeZone customImageUrn customImage allowUsageAnalytics allowPhoneHome numberOfInstances resourceGroupName "
