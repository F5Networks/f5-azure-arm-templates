...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceType imageName bigIqAddress bigIqUsername bigIqPassword bigIqLicensePoolName bigIqLicenseSkuKeyword1 bigIqLicenseUnitOfMeasure bigIpVersion vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart numberOfInstances declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
