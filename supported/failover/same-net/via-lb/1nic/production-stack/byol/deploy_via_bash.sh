...
required_variables="numberOfInstances adminUsername authenticationType adminPasswordOrKey uniqueLabel instanceType imageName bigIpVersion licenseKey1 licenseKey2 vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
