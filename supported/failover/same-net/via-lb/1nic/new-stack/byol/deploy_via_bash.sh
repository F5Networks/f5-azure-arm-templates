...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceType imageName bigIpVersion bigIpModules licenseKey1 licenseKey2 vnetAddressPrefix declarationUrl ntpServer timeZone customImage allowUsageAnalytics allowPhoneHome numberOfInstances resourceGroupName "
