...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion numberOfExternalIps vnetAddressPrefix ntpServer timeZone customImageUrl allowUsageAnalytics resourceGroupName licenseType "
