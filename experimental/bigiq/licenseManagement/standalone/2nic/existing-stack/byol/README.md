# Deploying the BIG-IQ VE License Manager in Azure - Standalone 2-NIC
...
This solution uses an experimental ARM Template to launch a 2-NIC deployment of a [BIG-IQ](https://www.f5.com/products/automation-and-orchestration/big-iq) License Manager VE in an Microsoft Azure, using a BYOL (bring your own license) BIG-IQ License Manager License.
...
- **BYOL** (bring your own license): This allows you to use an existing BIG-IP license.
  ...
  [![Deploy to Azure](http://azuredeploy.net/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FF5Networks%2Ff5-azure-arm-templates%2Fv7.2.0.0%2Fexperimental%2Fbigiq%2FlicenseManagement%2Fstandalone%2F2nic%2Fexisting-stack%2Fbyol%2Fazuredeploy.json)
...
| numberOfInternalIps | Yes | The number of public/private IP addresses you want to deploy for the application traffic (internal) NIC on the BIG-IQ VE to be used for virtual servers. |
