...
required_variables="adminUsername adminPassword vmRoleName masterKey dnsLabel instanceName instanceType bigIqVersion bigIqLicenseKey1 bigIqLicenseKey2 licensePoolKeys regPoolKeys vnetAddressPrefix ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
