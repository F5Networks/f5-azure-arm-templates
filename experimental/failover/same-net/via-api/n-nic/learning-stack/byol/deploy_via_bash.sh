...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName numberOfExternalIps instanceType imageName bigIpVersion bigIpModules licenseKey1 licenseKey2 vnetAddressPrefix declarationUrl ntpServer timeZone customImage allowUsageAnalytics numberOfAdditionalNics additionalNicLocation managedRoutes tenantId clientId servicePrincipalSecret resourceGroupName "
