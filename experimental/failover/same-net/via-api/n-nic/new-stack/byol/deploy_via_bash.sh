...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion licenseKey1 licenseKey2 numberOfAdditionalNics additionalNicLocation numberOfExternalIps vnetAddressPrefix declarationUrl tenantId clientId servicePrincipalSecret managedRoutes ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
