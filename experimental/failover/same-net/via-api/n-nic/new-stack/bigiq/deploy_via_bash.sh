...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName numberOfExternalIps instanceType imageName bigIqAddress bigIqUsername bigIqPassword bigIqLicensePoolName bigIqLicenseSkuKeyword1 bigIqLicenseUnitOfMeasure bigIpVersion bigIpModules vnetAddressPrefix routeTableName declarationUrl ntpServer timeZone customImageUrn customImage allowUsageAnalytics allowPhoneHome numberOfAdditionalNics additionalNicLocation userAssignedManagedIdentity roleNameGuid resourceGroupName "
