...
required_variables="numberOfInstances adminUsername authenticationType adminPasswordOrKey dnsLabel instanceType imageName bigIpVersion vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart declarationUrl ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
