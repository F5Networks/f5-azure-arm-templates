...
required_variables="numberOfInstances adminUsername authenticationType adminPasswordOrKey dnsLabel instanceType imageName bigIpVersion licenseKey1 licenseKey2 vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
