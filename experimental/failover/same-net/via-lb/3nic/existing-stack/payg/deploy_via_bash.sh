...
required_variables="adminUsername authenticationType adminPasswordOrKey dnsLabel instanceName instanceType imageName bigIpVersion licensedBandwidth numberOfExternalIps vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart externalSubnetName externalIpSelfAddressRangeStart externalIpAddressRangeStart internalSubnetName internalIpAddressRangeStart enableNetworkFailover internalLoadBalancerType internalLoadBalancerProbePort ntpServer timeZone customImage allowUsageAnalytics resourceGroupName "
