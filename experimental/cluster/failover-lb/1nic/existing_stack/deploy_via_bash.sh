...
required_variables="numberOfInstances adminUsername authenticationType adminPasswordOrKey dnsLabel instanceType imageName bigIpVersion vnetName vnetResourceGroupName mgmtSubnetName mgmtIpAddressRangeStart ntpServer timeZone allowUsageAnalytics resourceGroupName licenseType "
