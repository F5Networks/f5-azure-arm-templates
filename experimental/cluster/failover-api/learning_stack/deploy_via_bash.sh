...
required_variables="adminUsername adminPassword dnsLabel instanceName instanceType imageName bigIpVersion numberOfExternalIps vnetAddressPrefix tenantId clientId servicePrincipalSecret managedRoutes ntpServer timeZone allowUsageAnalytics resourceGroupName licenseType "
