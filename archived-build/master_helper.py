...
def parameter_initialize(data):
    ...
    data['parameters']['declarationUrl'] = "OPTIONAL"
    ...
    data['parameters']['enableMgmtPublicIp'] = "OPTIONAL"
...
def variable_initialize(data):
    ...
    data['variables']['f5CloudIappsSdTag'] = "MANDATORY"
    data['variables']['f5CloudIappsLoggerTag'] = "MANDATORY"
    data['variables']['f5AS3Tag'] = "MANDATORY"
    data['variables']['f5AS3Build'] = "MANDATORY"
    ...
    data['variables']['appScript'] = "OPTIONAL"
